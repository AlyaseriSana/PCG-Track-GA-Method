...
namespace TrackGA
{
    class GenerateTrack
    {
        ...
        public void drawTrack(chromosome CTrack, Pen pen, PaintEventArgs e1)
        {

            Graphics g = e1.Graphics;
            for (int i = 0; i < noPoints-1; i++)
                g.DrawBezier(pen, CTrack.GenSource[i], CTrack.GenSourceC1[i], CTrack.GenSourceC2[i], CTrack.GenSource[i + 1]);
